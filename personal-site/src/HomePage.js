        ...
        <Container maxWidth="md" sx={{
            ...
            <Paper sx={{
                ...
                <Typography variant="body1">
                    I'm a senior software engineer who loves to think about people. I strive on building APIs and infrastructure that will scale, not just technically, but also in how it is used by fellow engineers. <b>Currently I'm on a "personal sabbatical" after resigning from Facebook.</b>
                    <br /><br />
                ...
                <Typography variant="body1">
                    Ok, phew, glad that's over. I generally loathe the hustle-y nature of personal websites. Unfortunately, they are great at being a one-stop-shop for your professional background. Although this one isn't that full, it's a good start as I prepare to look for what's next.
                </Typography>
                <Divider sx={{ marginTop: "20px", marginBottom: "20px" }} />
                <Typography variant="h5" sx={{ textAlign: "center", fontWeight: "bold", marginBottom: "5px" }}>Links</Typography>
                <Typography variant="body1">
                    <ul>
                        <li><a target="_blank" rel="noopener noreferrer" href="https://drive.google.com/file/d/1q1Ad-jtYGRnoxciTZuCgiYDJDkqfBlDT/view?usp=sharing">Resume</a></li>
